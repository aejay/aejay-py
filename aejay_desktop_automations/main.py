"""
The main module for my desktop automations.
"""
import os
import atexit
...
def _main():
    ...
    def mqtt_change_handler(state: RemoteState):
        ...
        elif is_work_machine and state.current_task not in [
            ProductivityTask.PROJECT_WORK,
            ProductivityTask.OFFICE_WORK,
        ]:
            desired_state = FunkyState.STEP_AWAY
        elif not is_work_machine and state.current_task in [
            ProductivityTask.PROJECT_WORK,
            ProductivityTask.OFFICE_WORK,
        ]:
            desired_state = FunkyState.STEP_AWAY
