...
class Icon:
    ...
    def run(self, setup: Callable[["Icon"], None] = ...) -> None:
        ...
        """
        ...
    def run_detached(self, setup: Callable[["Icon"], None] = ...) -> None:
...
class MenuItem:
    ...
    def __init__(
        ...
        checked: bool | Callable[[], bool] | Callable[["MenuItem"], bool] = ...,
        radio: bool | Callable[[], bool] | Callable[["MenuItem"], bool] = ...,
        default: bool | Callable[[], bool] | Callable[["MenuItem"], bool] = ...,
        visible: bool | Callable[[], bool] | Callable[["MenuItem"], bool] = ...,
        enabled: bool | Callable[[], bool] | Callable[["MenuItem"], bool] = ...,
    ) -> None: ...
    def __call__(self, icon: Icon) -> Any | None: ...
...
class Menu:
    ...
    @property
    def items(self) -> tuple[MenuItem, ...] | tuple[MenuItem]:
        """All menu items."""
        ...
    @property
    def visible(self) -> bool:
